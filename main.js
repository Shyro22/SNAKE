(function (win, doc) {
  ...
  let tag = null;
  let  raf;
  const apple = new Audio('https://cdn.jsdelivr.net/gh/Shyro22/SNAKE@469c015bc6aae769b712a5ddb686686f29837297/apple.mp3');
  const gameover = new Audio('https://cdn.jsdelivr.net/gh/Shyro22/SNAKE@469c015bc6aae769b712a5ddb686686f29837297/over.mp3')
  ...
  function init() {
    ...
    directionalLight.position.set(1500,500,1300).normalize();
